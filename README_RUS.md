...
- Внутренняя реализация типа decimal может быть произвольной, но структура обязательно должна содержать [двоичный](#двоичное-представление) массив bits, как указано в [примере выше](#пример)
