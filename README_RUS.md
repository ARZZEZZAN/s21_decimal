...
| ------ | ------ | ------ |
| Сложение | + | s21_decimal add(s21_decimal, s21_decimal) |
| Вычитание | - | s21_decimal sub(s21_decimal, s21_decimal) |
| Умножение | * | s21_decimal mul(s21_decimal, s21_decimal) | 
| Деление | / | s21_decimal div(s21_decimal, s21_decimal) |
| Остаток от деления | Mod | s21_decimal mod(s21_decimal, s21_decimal) |

### Операторы сравнение

| Название оператора | Оператор  | Функция | 
| ------ | ------ | ------ |
| Меньше  | < | s21_int is_less(s21_decimal, s21_decimal) |
...
| Описание | Функция | 
| ------ | ------ |
| Округляет указанное Decimal число до ближайшего целого числа в сторону отрицательной бесконечности. | s21_decimal floor(s21_decimal) |	
| Округляет Decimal до ближайшего целого числа. | s21_decimal round(s21_decimal) |
| Возвращает целые цифры указанного Decimal числа; любые дробные цифры отбрасываются. | s21_decimal truncate(s21_decimal) |
| Возвращает результат умножения указанного Decimal на -1. | s21_decimal negate(s21_decimal) |
...
- Предусмотреть Makefile для сборки библиотеки и тестов (с целями all, clean, test, s21_decimal.a)
- Внутренняя реализация типа decimal может быть произвольной
