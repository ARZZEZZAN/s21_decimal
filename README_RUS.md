...
- *Если числа превышают пределы вместимости типа (|x| > 79,228,162,514,264,337,593,543,950,335 или 0 < |x| < 1e-28) или равны бесконечности, вернуть ошибку и значение, равное 0, value_type = 0*
...
- Конечные нули можно как оставлять, так и удалять
